...
## TL;DR
We're creating a web application for a Car ride-sharing service called Vroom (from the original [Amazon workshop](https://aws.amazon.com/serverless-workshops)).  The app uses IAM, Amplify, Cognito, Lambda, API Gateway and DynamoDB, with code stored in GitHub and incorporated into a CI/CD pipeline with Amplify.check out the app here at : [Vrooom](https://main.d1uqxmj7rboeos.amplifyapp.com)
